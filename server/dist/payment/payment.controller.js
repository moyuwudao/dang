...
let PaymentController = class PaymentController {
    ...
    async createRechargeOrder(req, body) {
    ...
    async getRechargeRecords(req, page, limit) {
        return this.paymentService.getRechargeRecords(req.user.sub, parseInt(page || '1', 10), parseInt(limit || '20', 10));
    }
};
...
], PaymentController.prototype, "createRechargeOrder", null);
__decorate([
...
__decorate([
    (0, common_1.Post)('alipay/callback'),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], PaymentController.prototype, "getRechargeRecords", null);
