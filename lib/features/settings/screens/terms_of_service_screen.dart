        ...
        child: Column(
          ...
          children: [
            ...
            _buildSection(
              ...
              content: '''By downloading, installing, or using Changji ("the App"), you agree to be bound by these Terms of Service. If you do not agree to these terms, please do not use the App.''',
            ),
            _buildSection(
              context,
              title: '2. Description of Service',
              content: '''Changji is an AI-powered voice notes application designed for one-person companies. The App provides:
...
• Compliance with OpenAI\'s terms of service''',
            ...
            _buildSection(
              ...
              content: '''The App requires you to provide your own OpenAI API key. By using this feature:
...
• You agree to comply with OpenAI\'s terms of service and usage policies''',
            ...
            _buildSection(
              ...
              content: '''The App and its original content, features, and functionality are owned by Changji and are protected by international copyright, trademark, patent, trade secret, and other intellectual property laws.
...
You retain all rights to the content you create using the App.''',
            ...
            _buildSection(
              ...
              content: '''To the maximum extent permitted by law, Changji shall not be liable for:
...
The App is provided "as is" without warranties of any kind.''',
            ...
            _buildSection(
              context,
              title: '7. Termination',
              content: '''We may terminate or suspend your access to the App immediately, without prior notice or liability, for any reason, including if you breach these Terms.
