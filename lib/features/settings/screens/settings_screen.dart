          ...
          _buildSection(
            ...
            children: [
              ...
              ListTile(
                ...
                title: const Text('澶欰PI閰嶇疆绠＄悊'),
                subtitle: const Text('涓鸿闊?鍥惧儚/鏂囨湰閰嶇疆鐙珛API锛屾敮鎸佸骞冲彴'),
                trailing: const Icon(Icons.chevron_right),
                        ...
                        children: [
                          ...stats.entries.map((entry) {
                            ...
                            return ListTile(
                              ...
                              subtitle: Text(
                                '$callCount ${l10n.calls} 路 $tokenCount ${l10n.tokens}${lastUsed != null ? ' 路 ${l10n.lastUsed}: ${_formatDate(lastUsed)}' : ''}',
                              ),
        ...
        content: Column(
          ...
          children: [
            ListTile(
              ...
              trailing: ref.watch(localeProvider).valueOrNull?.languageCode == 'en'
            ...
            ListTile(
              ...
              trailing: ref.watch(localeProvider).valueOrNull?.languageCode == 'zh'
                  ? const Icon(Icons.check, color: AppColors.primary)
                  : null,
              onTap: () {
